          ...
          <div className="side1">
            <div className="row">
              <div className="col-md-3">
                <h1 className="logo">Appliconsultants</h1>
                <p className="footer-text">
                  Excelling in providing services to our clients.
          ...
          <div className="side2">
            <div className="row">
              <div className="col-md-3">
                ...
                <ul>
                  <li>
                    <Link to="#" >A-312 Budh Nagar New Delhi</Link>
                  </li>
                  <li>
                    <Link to="#" > South West Delhi</Link>
                  </li>
                  <li>
                    <Link to="#" >DL 110012 IN</Link>
                  </li>
                </ul>
              </div>
              <div className="col-md-3">
